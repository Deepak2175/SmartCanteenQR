...
import { User, Mail, Phone, LogOut, Flag, ArrowLeft, AlertTriangle, Send, Loader2 } from "lucide-react";
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="px-4 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-100 shadow-sm active:scale-[0.98] transition-transform"
        >
          ...
          <div className="text-left flex-1">
            ...
            <p className="text-xs text-gray-500">Report problems with food or orders</p>
          </div>
        </button>
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 p-4 bg-white rounded-xl border border-red-100 shadow-sm active:scale-[0.98] transition-transform"
        >
